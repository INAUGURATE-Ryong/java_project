...
import day18.JDBC_MVC_ConnUtil.CloseHelper;
import day18.JDBC_MVC_ConnUtil.ConnectionHelper;
import day18.JDBC_MVC_ConnUtil.ConnectionSingletonHelper;
...
//            conn = ConnectionSingletonHelper.getConnection("mariadb");
    ...
    public static void menu() throws SQLException {  // 예외처리 위임
        ModelGiftDTO  dto = new ModelGiftDTO();
        while( true ) {
            System.out.println();
